...
WEATHERFLOW_COLLECTOR_VINEYARD_VANTAGE_HANDLER_ENABLED = (
    os.getenv("WEATHERFLOW_COLLECTOR_VINEYARD_VANTAGE_HANDLER_ENABLED", "False").lower()
    == "true"
)
...
WEATHERFLOW_COLLECTOR_IMPORT_START_DATE = os.getenv(
    "WEATHERFLOW_COLLECTOR_IMPORT_START_DATE"
)
WEATHERFLOW_COLLECTOR_IMPORT_END_DATE = os.getenv(
    "WEATHERFLOW_COLLECTOR_IMPORT_END_DATE"
)
